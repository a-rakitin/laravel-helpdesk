...
Local Docker Compose runs also include Mailpit for captured notification email.
Open http://localhost:8025 to inspect local emails generated by the application.
The Mailpit service is local-only and is not part of the documented production
deploy command.
